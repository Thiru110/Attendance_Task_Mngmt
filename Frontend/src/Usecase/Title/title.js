    ...
    <>
      <div className="title-box">
        ...
        <div id="tot-title">
          ...
          <br></br>
          <span id="project2">
            Empower Your Projects, Elevate Your Success.
          </span>
        </div>
        <div id="info-cont">
          <span id="line">
            {" "}
            Easily assign tasks and prioritize what's most important to your
            team. Track your team's progress, set project timelines, and manage
            their work all in one place.
          </span>
        </div>
      </div>
    </>
