...
function Projectdetails() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:4023/project_infos', inputValue)
...
/>
    ...
    >
        ...
        {names.map((name) => (
          ...
          >
            {name}
              ...
              <tr>
                <input type='date' id='startdate' name='Startdate' onChange={handleChange} style={{width:"300px",textAlign:"center",height:"50px",color:"white",position: 'relative', bottom:"-100px"}}/>
           
           
                <input type='date' id='enddate' name='Deadline' onChange={handleChange} style={{width:"300px",textAlign:"center",height:"50px",color:"white",position: 'relative', bottom:"-100px",left:'30px'}}/>
              </tr>
              <tr>
              <TextField
      type="Tools"
      ...
      onChange={handleChange}
      id='tool'
      style={{ marginTop: '15px', position: 'relative', top: 155, left: 0 }}
      InputLabelProps={{
        style: {
          fontSize: '13px',
          fontFamily: "'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif",
    ...
    />
           ...
           >
           file
           <input type="file" onChange={handleChange} name='attachment' style={{ display: 'none' }} />
